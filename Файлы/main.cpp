//Вариант 20(5) Лобов Александр Витальевич

/*Задача 2а (Реализовать чтение ID3v1 MP3-файла. Будьте внимательны, не все MP3-файлы
...
/*Задача 3E(Протабулировать функцию. Начальную и финальную точки, шаг, параметр Ч
